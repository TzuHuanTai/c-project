 ...
 *
 * .\stereo_match.exe im0.png im1.png --algorithm=sgbm --max-disparity=256 --blocksize=1 --color
 */
...
int main(int argc, char **argv)
{
    ...
    if (parser.has("algorithm"))
    {
        ...
        alg = _alg == "bm" ? STEREO_BM : _alg == "sgbm"   ? STEREO_SGBM
                                     : _alg == "hh"       ? STEREO_HH
                                     : _alg == "var"      ? STEREO_VAR
                                     : _alg == "hh4"      ? STEREO_HH4
    ...
    if (!no_display)
    {
        ...
        oss << "disparity  " << (alg == STEREO_BM ? "bm" : alg == STEREO_SGBM ? "sgbm"
                                                       : alg == STEREO_HH     ? "hh"
                                                       : alg == STEREO_VAR    ? "var"
                                                       : alg == STEREO_HH4    ? "hh4"
        ...
        int method = scale < 1 ? INTER_AREA : INTER_CUBIC;
        Mat temp1;
        resize(color_display ? disp8_3c : disp8, temp1, Size(), scale, scale, method);
        imshow(disp_name, temp1);
