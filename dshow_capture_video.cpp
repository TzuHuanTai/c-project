...
int main(int argc, char **argv)
{
    ...
    const AVFilter *buffersrc_cam = avfilter_get_by_name("buffer");
    ...
    ret = avformat_open_input(&pFormatCtxInCam, "video=HP HD Camera", inFrmt, &inOptions);
